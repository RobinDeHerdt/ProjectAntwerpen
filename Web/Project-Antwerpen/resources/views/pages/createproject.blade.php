...
<div class="container" style="margin-top: 100px; margin-bottom: 100px;">
    ...
    <div class="row setup-content step hiddenStepInfo" id="step-4" ng-app="FaseApp">
        <div class="col-xs-12" ng-controller="FasenController as FaseCon">
            ...
            <h1>Tijdlijn</h1>
            <div class="form-group">
                   <input type="button" value="Projectfase toevoegen" class="btn btn-width btn-success btn-lg" id="btn-button-milestone" onclick="" alt="Voeg een projectfase toe">
             </div>
            ...
            <h3 id="noFases" ng-show="FaseCon.faseCount">Er zijn nog geen fases aangemaakt voor dit project</h3>
              <div id="addMilestone" class="form-group">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <select ng-model="milestone.icon" class="c-select form-control input-md" id="milestone_image" name="milestone_image" alt="Kies een icoontje voor deze projectfase" value="{{old('milestone_image')}}">
                        <option value="/img/in_progress.png"   alt="In progress (Tandwiel)">     In progress (Tandwiel)  </option>
                        <option value="/img/in-progress.png"   alt="In progress (Hamer)">        In progress (Hamer) </option>
                        <option value="/img/caution.png"       alt="Waarschuwing">               Waarschuwing</option>
                        <option value="/img/oke.png"           alt="Voltooid">                   Voltooid</option>
                    </select>
                </div>
                <div class="form-group">
                    <label class="control-label">Startdatum</label>
                ...
                <div class="form-group">
                   ...
                   <textarea ng-model="milestone.milestoneInfo" class="form-control input-md" rows="5" id="mijlpaal_info" placeholder="Uitleg over het projectfase" alt="Vul hier uitleg over de projectfase in" name="mijlpaal_info">{{old('mijlpaal_info')}}</textarea>
               </div>

              </div>
              <input type="hidden" id="remembertimeline" value="{{old('milestone_json')}}">
              <input type="text" name="milestone_json" id="milestone_json" class="form-control input-md hidden" alt="Vul hier de einddatum van de projectfase in." value="<% FaseCon.fases %>">
